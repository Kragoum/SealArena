...
public class ActionSystem : Singleton<ActionSystem>
{
    ...
    {
        Type type = typeof(T);
        Dictionary<Type, List<Action<GameAction>>> subs = GetTimingSub(timing);
    ...
    private static Dictionary<Type, List<Action<GameAction>>> GetTimingSub(ReactionTiming timing)
    {
